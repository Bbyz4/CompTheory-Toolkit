...
bootstrap_mock_seed=${LOCAL_DEPLOY_RECOGNITA_BOOTSTRAP_MOCK_SEED:-20260508}
bootstrap_mock_users=${LOCAL_DEPLOY_RECOGNITA_BOOTSTRAP_MOCK_USERS:-10}
bootstrap_mock_problems=${LOCAL_DEPLOY_RECOGNITA_BOOTSTRAP_MOCK_PROBLEMS:-20}
bootstrap_mock_submissions=${LOCAL_DEPLOY_RECOGNITA_BOOTSTRAP_MOCK_SUBMISSIONS:-1000}
...
RECOGNITA_BOOTSTRAP_MOCK_SEED=$bootstrap_mock_seed
RECOGNITA_BOOTSTRAP_MOCK_USERS=$bootstrap_mock_users
RECOGNITA_BOOTSTRAP_MOCK_PROBLEMS=$bootstrap_mock_problems
RECOGNITA_BOOTSTRAP_MOCK_SUBMISSIONS=$bootstrap_mock_submissions
TZ=$tz_value
